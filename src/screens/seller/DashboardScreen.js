  ...
  const renderActivityItem = ({item}) => (
    <View
      ...
      <View className="flex-row items-center flex-1">
        <View
          className="h-12 w-12 rounded-xl items-center justify-center mr-4 border"
          style={{
            borderColor: utils.colors.lightGrey,
          }}>
          <Image
    ...
    <SafeAreaView
      ...
      <View className="flex-1">
        <View
          ...
          <View
            className="mx-5 my-3 rounded-2xl p-5"
            style={{
            ...
            <View className="flex-row justify-between items-start">
              ...
              <View
                className="h-7 w-7 rounded-full border items-center justify-center mt-1"
                style={{
          ...
          <View className="flex-row justify-between px-4 py-4">
            <TouchableOpacity
              onPress={() => setSelectedCard('auctions')}
              className="border-2 rounded-xl items-center flex-1 py-3 mx-1"
              style={{
                borderColor:
            ...
            <TouchableOpacity
              onPress={() => setSelectedCard('orders')}
              className="border-2 rounded-xl items-center flex-1 py-3 mx-1"
              style={{
                borderColor:
                  selectedCard === 'orders'
            ...
            <TouchableOpacity
              onPress={() => setSelectedCard('earnings')}
              className="border-2 rounded-xl items-center flex-1 py-3 mx-1"
              style={{
                borderColor:
